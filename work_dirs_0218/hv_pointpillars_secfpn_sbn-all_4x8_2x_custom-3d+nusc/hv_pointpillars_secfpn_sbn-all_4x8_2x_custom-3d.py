...
db_sampler = dict(
    data_root='data/2022-02-18+nusc-mini/',
    info_path=
    'data/2022-02-18+nusc-mini/2022-02-18+nusc-mini_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            data_root='data/2022-02-18+nusc-mini/',
            ann_file=
            'data/2022-02-18+nusc-mini/2022-02-18+nusc-mini_infos_train.pkl',
            split='training',
    ...
    val=dict(
        type='KittiDataset',
        data_root='data/2022-02-18+nusc-mini/',
        ann_file='data/2022-02-18+nusc-mini/2022-02-18+nusc-mini_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
        pipeline=[
            dict(
