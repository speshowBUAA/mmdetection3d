...
db_sampler = dict(
    data_root='data/2022-02-18/',
    info_path='data/2022-02-18/2022-02-18_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='KittiDataset',
            data_root='data/2022-02-18/',
            ann_file='data/2022-02-18/2022-02-18_infos_train.pkl',
            split='training',
            ...
            pipeline=[
                ...
                dict(
                    ...
                    db_sampler=dict(
                        data_root='data/2022-02-18/',
                        info_path=
                        'data/2022-02-18/2022-02-18_dbinfos_train.pkl',
                        rate=1.0,
                        prepare=dict(
                            filter_by_difficulty=[-1],
    ...
    val=dict(
        type='KittiDataset',
        data_root='data/2022-02-18/',
        ann_file='data/2022-02-18/2022-02-18_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
        pipeline=[
            dict(
...
log_level = 'INFO'
work_dir = './work_dirs/hv_pointpillars_secfpn_sbn-all_4x8_2x_custom-3d-range25'
load_from = None
resume_from = None
workflow = [('train', 1)]
