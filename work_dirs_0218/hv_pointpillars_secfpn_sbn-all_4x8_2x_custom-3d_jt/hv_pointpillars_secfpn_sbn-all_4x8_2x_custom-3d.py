...
db_sampler = dict(
    data_root='data/2022-02-22_24-jt/',
    info_path='data/2022-02-22_24-jt/2022-02-22_24-jt_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='KittiDataset',
            data_root='data/2022-02-22_24-jt/',
            ann_file='data/2022-02-22_24-jt/2022-02-22_24-jt_infos_train.pkl',
            split='training',
    ...
    val=dict(
        type='KittiDataset',
        data_root='data/2022-02-22_24-jt/',
        ann_file='data/2022-02-22_24-jt/2022-02-22_24-jt_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
        pipeline=[
            dict(
...
log_level = 'INFO'
work_dir = './work_dirs/hv_pointpillars_secfpn_sbn-all_4x8_2x_custom-3d'
load_from = 'work_dirs/hv_pointpillars_secfpn_sbn-all_4x8_2x_custom-3d_jt/epoch_11.pth'
resume_from = None
workflow = [('train', 1)]
