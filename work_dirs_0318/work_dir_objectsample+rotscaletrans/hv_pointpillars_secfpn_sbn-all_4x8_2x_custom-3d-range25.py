...
db_sampler = dict(
    ...
    rate=1.0,
    prepare=dict(
        filter_by_difficulty=[-1], filter_by_min_points=dict(Pedestrian=10)),
    classes=['Pedestrian'],
            ...
            pipeline=[
                ...
                dict(
                    ...
                    db_sampler=dict(
                        data_root='data/2022-03-18/',
                        info_path=
                        'data/2022-03-18/2022-03-18_dbinfos_train.pkl',
                        rate=1.0,
                        prepare=dict(
                            filter_by_difficulty=[-1],
                            filter_by_min_points=dict(Pedestrian=10)),
...
log_level = 'INFO'
work_dir = 'work_dirs_0318/work_dir_objectsample+rotscaletrans'
